...
ActiveRecord::Schema[8.0].define(version: 2026_09_15_000000) do
  ...
  create_table "community_pulse_votes", force: :cascade do |t|
    t.string "topic", null: false
    t.string "fingerprint", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_community_pulse_votes_on_created_at"
    t.index ["fingerprint"], name: "index_community_pulse_votes_on_fingerprint", unique: true
    t.index ["topic"], name: "index_community_pulse_votes_on_topic"
  end
  ...
  create_table "opportunities", force: :cascade do |t|
    ...
    t.string "acquisition_channel", default: "cold_application", null: false
